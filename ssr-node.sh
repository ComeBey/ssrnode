...
#   Author: ComeBey <comebey@foxmail.com>                           #
#   github: @comebey <https://github.com/ComeBey>                   #
#   Blog:  RootFW https://rootfw.com                                #
#===================================================================#
#
#  
# ██████╗ ██████╗ ███╗   ███╗███████╗██████╗ ███████╗██╗   ██╗
...
start_menu(){
 ...
    greenbg "==============================================================="
    ...
    #green "TVCAT官网地址：https://ssr.comebey.net IEPL及IPLC内网专线"    
    echo
    white "-------------程序安装（二选一）-------------"
     ...
     #   then
      #  echo
       # echo 授权成功！
        #else
        #echo
       # echo "授权失败！请联系https://rootfw.com查看最新授权码"
      #  echo "一次授权，永久维护，请支持正版"
     #   echo "请购买或访问https://rootfw.com 自助购买，随时下单"
    #    printf "https://rootfw.com" | curl -F-=\<- qrenco.de                
    #exit 0;
     #fi
    case "$num" in
    1)
